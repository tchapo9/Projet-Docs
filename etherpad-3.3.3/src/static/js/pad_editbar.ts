...
exports.padeditbar = new class {
  ...
  _registerDefaultCommands() {
    ...
    // Lumen Docs — color text / highlight via toolbar selects.
    this.registerAceCommand('textcolor', (cmd, ace, item) => {
      ace.ace_setAttributeOnSelection('textcolor', item.getValue());
    });
    this.registerAceCommand('bg', (cmd, ace, item) => {
      ace.ace_setAttributeOnSelection('bg', item.getValue());
    });
