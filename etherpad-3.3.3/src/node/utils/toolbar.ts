...
// Lumen Docs — color text + highlight selects (Google Docs style).
// The select onchange delivers the chosen color as the command value.
module.exports.registerButton('textcolor', new SelectButton({
        command: 'textcolor',
        id: 'textcolor',
        selectId: 'textcolor-select',
        localizationId: 'pad.toolbar.textcolor.title',
    })
    .addOption('', 'Text color', {'class': 'textcolor-option textcolor-default'})
    .addOption('e11d48', 'Red', {'class': 'textcolor-option swatch-red'})
    .addOption('f59e0b', 'Amber', {'class': 'textcolor-option swatch-amber'})
    .addOption('16a34a', 'Green', {'class': 'textcolor-option swatch-green'})
    .addOption('2563eb', 'Blue', {'class': 'textcolor-option swatch-blue'})
    .addOption('7c3aed', 'Purple', {'class': 'textcolor-option swatch-purple'})
    .addOption('334155', 'Black', {'class': 'textcolor-option swatch-black'}));

module.exports.registerButton('bg', new SelectButton({
        command: 'bg',
        id: 'bg',
        selectId: 'bg-select',
        localizationId: 'pad.toolbar.bg.title',
    })
    .addOption('', 'No highlight', {'class': 'bg-option bg-default'})
    .addOption('fecaca', 'Red', {'class': 'bg-option swatch-red'})
    .addOption('fde68a', 'Yellow', {'class': 'bg-option swatch-amber'})
    .addOption('bbf7d0', 'Green', {'class': 'bg-option swatch-green'})
    .addOption('bfdbfe', 'Blue', {'class': 'bg-option swatch-blue'})
    .addOption('e9d5ff', 'Purple', {'class': 'bg-option swatch-purple'}));
